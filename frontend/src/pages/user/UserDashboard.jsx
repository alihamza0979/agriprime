...
export default function UserDashboard() {
  ...
  const navItems = [
    ...
    { id: 'orders', label: 'Orders', icon: 'shopping_cart', path: '/dashboard/orders' },
    { id: 'wishlist', label: 'Wishlist', icon: 'favorite', path: '/dashboard/wishlist' },
    ...
    <div style={{ display: 'flex', height: '100vh', overflow: 'hidden', background: '#f5fced' }}>
      ...
      <aside style={{
        ...
        <div style={{
          ...
          {!collapsed && <span style={{ color: '#fff', fontWeight: 'bold' }}>AgriPrime</span>}
        </div>
      ...
      <main style={{
        ...
        <div style={{
          ...
          <div>
            <h1 style={{ fontSize: '24px', fontWeight: 'bold', color: '#1b1b1b' }}>Dashboard</h1>
